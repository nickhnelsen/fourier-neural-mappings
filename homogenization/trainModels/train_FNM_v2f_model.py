...
from models.vec_to_func2d import FND2d
...
def train_model(config):
    ...
    with open(data_path, 'rb') as handle:
        A_params, chi1_true, chi2_true  = pkl.load(handle)
    ...
    s_latentspace = (sgc,sgc)

    # Initialize model
    net = FND2d(d_in, s_latentspace, modes1 = N_modes, modes2= N_modes, d_out = d_out,width = width)
    ...
    loss_report(y_test_approx_all, y_test, A_test, model_path)
