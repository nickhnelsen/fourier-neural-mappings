...
from models import FNF1d as my_model
...
sub_in = 2**2       # input subsample factor (power of two) from s_max_in = 4097
...
model = my_model(modes1, width, d_in=d_in, d_out=N_qoi, n_layers=n_layers).to(device)
print(model)
