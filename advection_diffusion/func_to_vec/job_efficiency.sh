...
do
    ...
    do
        srun --exclusive --ntasks=1 python -u train_fnf.py $save_prefix $data_suffix $N $d $sigma | tee ${save_prefix:0:1}_n${N}_d${d}_s${sigma}_${data_suffix::-7}.out &
    done
    wait
done
